...
| suggestType     | No       | `string`                    | '[address](https://dadata.ru/api/suggest/address/)' (normal) or '[fias](https://dadata.ru/api/suggest/fias/)' (deprecated by DaData)                                                                                                                | `address`                                                                                                 |
...
| payload         | No       | `object`\|`object[]`        | Optional parameters to include in each DaData API request. Any fields specified here will be added to the final request payload, or will override existing values if already set by other options.                                                  | `undefined`                                                                                               |
