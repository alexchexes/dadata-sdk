...
| showOnFocus       | Controls when to show the dropdown with suggestions list on input focus                                             | `'no_selection'` \| `'always'` \| `false` | `'no_selection'`                                                                                          |
...
| clearOnChange     | Determines whether the suggestion (`v-model:suggestion`) is cleared when the input (`v-model`) changes              | `'significant'` \| `'any'` \| `false`     | `'significant'`                                                                                           |
