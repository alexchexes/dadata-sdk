...
| `v-model:suggestion`                     | No       | `object` | v-model for the selected [suggestion](https://github.com/rusproject/vue-dadata/blob/rewritten/src/types/suggestion.dto.ts#L24) | `undefined` |
...
| locationsFilter  | No       | `object`\|`object[]`        | [Restrict search by locations](https://confluence.hflabs.ru/pages/viewpage.action?pageId=204669108)                                                                                                                                                 | `undefined`                                                                                                               |
