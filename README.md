...
| headers         | No       | `RawAxiosRequestHeaders`    | Custom **headers** for the API request. Any headers specified here will be added to the final request headers, or override existing values if already set.                                                                                          | `undefined`                                                                                               |
